...
import { Activity, BarChart2, LayoutDashboard, LogOut, Settings, User as UserIcon, Key, Database, Info, History, FlaskConical } from "lucide-react";
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20">
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h2 className="text-xl font-display font-bold text-white tracking-tight">Performans ve Portföy Analitiği</h2>
                        <p className="text-xs text-slate-400">Tüm botlarınızın toplam performansını ve detaylı işlem raporlarını izleyin</p>
                    </div>
                </div>
