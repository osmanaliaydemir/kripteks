                    ...
                    <div className="space-y-1">
                        ...
                        >
                            ...
                            <h1 className="text-3xl font-black text-white tracking-tight">
                                Market <span className="text-primary italic">Scanner</span>
                            </h1>
                        </motion.div>
                        <p className="text-slate-400 text-sm font-medium pl-14">
                            Stratejinize göre alım yapmaya en yakın fırsatları keşfedin.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                        ...
                        >
                            ...
                            <div className="text-xs">
                                ...
                                <div className="text-slate-500 font-medium">Paneli görüntüle</div>
                            </div>
                        </Link>
                        ...
                        >
                            ...
                            <div className="text-xs">
                                <div className="text-white font-bold tracking-tight">Dinamik Tarama</div>
                                <div className="text-slate-500 font-medium">Real-time analiz</div>
                            </div>
                        </motion.div>
                    </div>
                </div>
