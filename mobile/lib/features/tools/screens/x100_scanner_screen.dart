...
import 'package:mobile/features/scanner/providers/scanner_provider.dart';
import 'package:mobile/features/scanner/models/scanner_model.dart';
import 'package:mobile/features/scanner/widgets/scanner_symbol_selection_sheet.dart';
import 'package:mobile/core/providers/market_data_provider.dart';
import 'package:mobile/features/backtest/providers/backtest_provider.dart';
import 'package:mobile/features/backtest/models/strategy_model.dart';
import 'dart:async';
import 'package:go_router/go_router.dart';

class X100ScannerScreen extends ConsumerStatefulWidget {
  const X100ScannerScreen({super.key});

  @override
  ConsumerState<X100ScannerScreen> createState() => _X100ScannerScreenState();
}

class _X100ScannerScreenState extends ConsumerState<X100ScannerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final bistPairsAsync = ref.watch(bistPairsProvider);
                ...
                children: [
                  ...
                  Text(
                    _selectedSymbols.isEmpty
                        ? 'Tüm Hisseler'
                        : '${_selectedSymbols.length} hisse seçili',
